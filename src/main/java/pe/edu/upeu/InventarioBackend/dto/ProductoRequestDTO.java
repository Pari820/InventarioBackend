...
public class ProductoRequestDTO {
    ...
    @Pattern(regexp = "^[A-Z]{3}-\\d{3}$", message = "El código debe tener formato AAA-999")
    ...
    @Digits(integer = 8, fraction = 2, message = "El costo unitario debe tener como máximo 2 decimales")
